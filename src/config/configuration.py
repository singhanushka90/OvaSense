...
from src.entity.config_entity import DataIngestionConfig,DataValidationConfig,FeatureEngineeringConfig,DataTransformationConfig,ModelTrainingConfig,ModelEvaluationConfig
...
class ConfigurationManager:
    ...
    def get_feature_engineering_config(self)->FeatureEngineeringConfig:
        ...
        feature_engineering_config=FeatureEngineeringConfig(root_dir=config.root_dir,
                                                            ...
                                                            local_data_file=config.local_data_file,
                                                            sheet_name=config.sheet_name,
                                                            selected_features=self.params.selected_features
                                                        )
    ...
    def get_model_evaluation_config(self)->ModelEvaluationConfig:
        ...
        model_evaluation_config=ModelEvaluationConfig(root_dir=config.root_dir,
                                                      ...
                                                      test_features_path=self.config.data_transformation.test_features_path,
                                                      test_target_path=self.config.data_transformation.test_target_path,
